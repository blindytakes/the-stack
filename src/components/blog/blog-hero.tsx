...
export function BlogHero({ featured }: BlogHeroProps) {
  ...
  return (
    <section className="mt-10 md:mt-12">
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1.46fr)_minmax(320px,0.9fr)] lg:items-start lg:gap-6">
        <Link
          href={`/blog/${main.slug}`}
        ...
        >
          <div className="relative">
            <BlogCoverImage
              ...
              className="aspect-[16/10] lg:aspect-[16/8.5]"
          ...
          <div className="p-6 lg:p-7">
            ...
            <h2 className="mt-4 max-w-[13ch] font-heading text-[2.1rem] leading-[0.98] text-text-primary transition group-hover:text-brand-coral lg:max-w-[12ch] lg:text-[2.8rem]">
              {main.title}
            </h2>
            ...
            {main.keyTakeaway && (
              <blockquote className="mt-5 border-l-2 border-brand-coral/50 pl-4 text-[13px] italic leading-6 text-text-secondary/90">
                {main.keyTakeaway}
              </blockquote>
            )}
          </div>
          ...
          {side.slice(0, 2).map((article) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="mt-4 text-[1.08rem] font-semibold leading-7 text-text-primary transition group-hover:text-brand-coral">
                  {article.title}
                </h3>
                <p className="mt-3 line-clamp-2 text-sm leading-6 text-text-secondary">{article.description}</p>
              </div>
            </Link>
          ))}
        </div>
