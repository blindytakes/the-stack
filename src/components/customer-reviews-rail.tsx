        ...
        >
          ...
          {reviews.map((review, index) => (
            <article
              ...
              className="flex min-h-[470px] w-[320px] min-w-[320px] shrink-0 snap-start flex-col rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm md:w-[380px] md:min-w-[380px]"
            >
